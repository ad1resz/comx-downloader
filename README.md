...
**Графический загрузчик комиксов для сайта `com-x.life`.**

Приложение позволяет искать комиксы, выбирать главы и скачивать их в формате `jpg` или `cbr`.

---

## О приложении

Это GUI-приложение на Python для автоматического скачивания комиксов с сайта **com-x.life**.
